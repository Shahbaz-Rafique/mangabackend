...
router.post('/',(req,res,next)=>{
  ...
  .catch((err) => {
    ...
    let mailOptions = {
      ...
      html: `<p>Hy ${firstname}!</p><p>We warmly welcome you in the Mangas world. Kindly verify your email to continue your journey in the Mangas world.</p><br/><center><a href="http://64.111.99.238:8080/verification?email=${email}"><button style="color:#FFA153;background-color:#0F0D3D;font-weight:bold;width:170px;height:34px">Verify Your Email</button></a></center>`
    };
