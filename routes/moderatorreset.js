    ...
    Publisher.findOne({email:email}).then((result)=>{
        if(result){
            ...
            if(verify==hashpass){
                    ...
                    "password":changepassword,
                        ...
                        .then((doc)=>{
                            let mailOptions = {
                                ...
                                html: `<p>Dear Staff! Your mangas account password has been reset. Now you can login with your new password.</p>`
                            };
                            transporter.sendMail(mailOptions, (error, info) => {
                                ...
                                return res.redirect(`http://staff.toonvortex.com?passreset=true`);
                                }
                            });
                            })
                        .catch((err) => {
                ...
                res.redirect(`http://staff.toonvortex.com/forgot-password/verification?email=${email}&id=${hashpass}&verify=false`);
            }
        }
    })
})
